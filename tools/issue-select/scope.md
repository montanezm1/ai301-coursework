...
I have experience with Python, JavaScript, Git, and basic web development.
I want to improve debugging, testing, and working in an unfamiliar codebase.
I prefer a small, clearly bounded bug or documentation task that can be
completed within one week. I want to avoid large architectural changes,
advanced infrastructure work, and tasks requiring specialized mathematics.
